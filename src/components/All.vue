<template>
    <div class="box">
            ...
            <div class="price">
              ...
              <div class="status" v-if="item.status === '待收货'">{{item.status}}</div>
              <div class="status2" v-if="item.status === '已完成'">{{item.status}}</div>
              <div class="d-flex message">
                ...
                <button class="confirm" :disable="dis"  v-if="item.status === '待收货'" @click="confirms(item.orderId)">确认收货</button>
                <button class="confirm" :disable="dis1"  v-if="item.status === '已完成'" @click="confirms2">确认收货</button>
              </div>
